        ...
        <div class="top-bar">
            <div class="content-topbar flex-sb-m h-full container">
                ...
                <div class="right-top-bar flex-w h-full">
                    ...
                    @auth
                        <a href="{{ route('user.profile', auth()->user()->id) }}" class="flex-c-m trans-04 p-lr-25">
                            {{ auth()->user()->name }}
                        </a>
                        <a href="{{ route('user-order-list') }}" class="flex-c-m trans-04 p-lr-25">
                            My Orders    
                        </a>
