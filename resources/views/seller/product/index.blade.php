...
@section('title', 'Seller Product | Seller Ecom530')
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox">
                        ...
                        @if($data)
                            @foreach($data as $key =>$value)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('seller.product.edit', $value->id) }}" class="btn btn-success" style="border-radius: 50%;">
                                            <i class="fa fa-pencil"></i>
                                        </a>

                                        {{ Form::open(['url'=>route('seller.product.destroy', $value->id), 'class'=>'form float-right', 'onsubmit'=>'return confirm("Are you sure you want to delete this product?")']) }}
                                        @method('delete')
