...
@section('title', 'Product Form| Seller Ecom530')
@section('styles')
            ...
            <div class="ibox">
                ...
                <div class="ibox-body">
                    @if(isset($product_detail))
                        {{Form::open(['url'=>route('seller.product.update', $product_detail->id), 'files'=>true, 'class'=>'form'])}}
                        @method('put')
                    @else
                        {{Form::open(['url'=>route('seller.product.store'), 'files'=>true, 'class'=>'form'])}}
                    @endif
