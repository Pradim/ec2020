<?php $__env->startSection('title', 'Seller Cart | Seller Ecom530'); ?>
                                    ...
                                    <td>
                                       <form class="form-validate" method="post" enctype="multipart/form-data" action="<?php echo e(route('cart.update', $value->id)); ?>">
                                            ...
                                            <select class="status" name="status" onchange="this.form.submit()" class="form-control" required>
                                                ...
                                                <option value="new" <?php echo e($cart_data_avail && ( 'new'== $value->status) ? "selected = 'selected'" : ""); ?> disabled>
                                                    New
                                                </option>
                                                <option value="cancelled" <?php echo e($cart_data_avail && ( 'cancelled'== $value->status) ? "selected = 'selected'" : ""); ?> disabled>
                                                    Cancelled
                                                </option>
                                                <option value="verified" <?php echo e($cart_data_avail && ( 'verified'== $value->status) ? "selected = 'selected'" : ""); ?> disabled>
                                                    Verified
                                                </option>
                                                <option value="processing" <?php echo e($cart_data_avail && ( 'processing'== $value->status) ? "selected = 'selected'" : ""); ?> disabled>
                                                    Processing
                                                </option>      
...
<?php echo $__env->make('layouts.seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ecom-530-v2\resources\views/seller/order/index.blade.php ENDPATH**/ ?>